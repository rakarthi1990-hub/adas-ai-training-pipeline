...
MODEL_PATHS = {
    "onnx_fp32": r"src/runs/runs/nuscenes_yolov8n/weights/best.onnx",
    "onnx_int8": r"src/runs/runs/nuscenes_yolov8n/weights/best_int8.onnx",
}
...
RUNS = 50
WARMUP = 10
OUT_CSV = r"outputs\deployment\onnx_comparison.csv"
...
def main():
    ...
    if not images:
        raise ValueError("No images loaded. Check IMG_DIR.")
